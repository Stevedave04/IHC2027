    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          ...
          'From the airport, the venue is a 25–35 minute taxi (€35–45) straight down the M50 — you never touch city-centre traffic. Ride-hailing apps (FREE NOW, Uber, Bolt) all operate at the airport.',
        ],
      },
      {
      ...
      },
      {
        ...
        paras: [
          'Ireland uses the euro, plugs are the UK three-pin type G, and April weather is best described as ‘all four seasons before lunch’ — pack a light rain layer and you are covered. EU delegates need no documentation beyond a passport or national ID; UK delegates can use the Common Travel Area. Questions about access requirements? Contact us ahead of time and we will make the arrangements.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          ...
          'IHC 2027 will give you the techniques, the science and the CPD hours. Ireland will give you the rest. Sixteen to eighteen April, Clayton Hotel Liffey Valley — and the city, the mountains and the music thrown in free.',
        ],
      },
    ],
  },
