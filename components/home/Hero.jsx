...
export default function Hero() {
  return (
    <section className="hero" id="main" aria-labelledby="hero-hl">
      <img width="1600" height="629" src="/IHC2027/ihc2026.jpeg" alt="" className="hero-bg" aria-hidden="true" fetchPriority="high" />
      ...
      <div className="hero-logo-wrap">
        <img width="160" height="150" src="/IHC2027/logo.png" alt="Irish Hypnotherapy Conference" />
      </div>
      ...
      <Countdown />
      <a href="/IHC2027/ihc2027.ics" download="ihc2027.ics" className="add-cal">
